class Slider {
    constructor(data) {
        ...
        this.sliderBoxItemWidth = 590;
    }
    init() {
        this.createUI(); //1、创建标签
        this.autoPlayer(); //3、自动播放
        this.addEventHandlerWithSlider();//点击走
    ...
    createSliderControl() {
        ...
        this.sliderControl.html('<span class="prev"><i class="iconfont icon-mjiantou-copy"></i></span> <span class="next"><i class="iconfont icon-youjiantou2"></i></span>');
    }
    createSliderNav() {
